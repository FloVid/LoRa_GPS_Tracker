...
//Variables for new coordinates incomming
int32_t newlat = 0;
int32_t newlong = 0;

//Battery reading variable
float VBAT = 3.7; //Oscar average max voltaje supply for a LiPo battery 3.7 V, play with this value
...
DeviceClass_t gCurrentClass = CLASS_A;          /* class definition, LoRaWan® 1.0.2 protocol stack (supports Class A & C)*/
LoRaMacRegion_t gCurrentRegion = LORAMAC_REGION_US915; /*Region: US915*/
...
//rak4631-flvd-02
uint8_t nodeDeviceEUI[8] = {0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x11, 0x22};
uint8_t nodeAppEUI[8] = {0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x11, 0x22};
uint8_t nodeAppKey[16] = {0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0x00};
...
#define LORAWAN_APP_INTERVAL 20000  //Cada 20 segundos, 20000 ms   /**< Defines for user timer, the application data transmission interval. 10s, value in [ms]. */
...
{ 
  ...
  if (newData)
  {
    float bat = analogRead(A0)*0.0122314453125;
